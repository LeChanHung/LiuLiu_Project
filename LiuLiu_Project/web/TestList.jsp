            ...
            <div id="header">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <!-- ACCOUNT -->
                        <ul class="header-links pull-right">
                            <li style="font-size: 24px"><a href="UserProfile.jsp"><i class="fa fa-user-o"></i> ${name}</a><br></li>
                            <li style="font-size: 24px"><a href="#"><i class="fa fa-user-o"></i> Logout</a></li>
                        </ul>
                        <!-- /ACCOUNT -->
                    </div>
                    <!-- row -->
            ...
            <div class="container">
                ...
                <div id="responsive-nav">
                    ...
                    <ul class="main-nav nav navbar-nav">
                        <li><a href="userlist">User Manage</a></li>
                        <li><a href="testlist">Test Manage</a></li>
                    </ul>
                    <!-- /NAV -->
                </div>
                <!-- /responsive-nav -->
        ...
        <div>
            ...
            <c:forEach items="${data}" var="u">
                <tr>
                    <td>${u.getId()}</td>
                    <td>${u.getName()}</td>
                    <td><a href="detail?id=${u.getId()}">Detail</a></td>
                </tr>
            </c:forEach>
        </table>
        </div>
                    ...
                    <div class="col-md-4 col-xs-6">
                        <div class="shop">
                            ...
                            <div class="shop-body">
                                ...
                                <a href="#" class="cta-btn">Test now <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                     /shop 
