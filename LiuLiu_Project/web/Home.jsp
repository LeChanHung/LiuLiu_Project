                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <ul class="header-links pull-right">
                            ...
                            <li style="font-size: 24px"><a href="Login.jsp"><i class="fa fa-user-o"></i> Login</a></li>
                        </ul>
                        <!-- /ACCOUNT -->
                    </div>
                    <!-- row -->
                    ...
                    <div class="col-md-4 col-xs-6">
                        <div class="shop">
                            ...
                            <div class="shop-body">
                                ...
                                <a href="Login.jsp" class="cta-btn">Test now <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- /shop -->
